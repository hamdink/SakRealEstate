        ...
        <div className="flex flex-col justify-normal gap-4 items-center p-2">
          <div className="flex flex-col items-start gap-3 ">
            ...
            <p className="text-[#808080] font-normal text-base">
              ...
              professionalism are at the core of everything we do. e pride{" "}
              <br />
          ...
          <div className="flex flex-col items-center gap-3 justify-center">
            <div
              ...
              className="  sm:w-[412px] flex justify-normal items-center gap-4 rounded-[30px] p-6 "
            >
              ...
              <div>
                ...
                <p className="text-[#808080] font-normal text-base">
                  Find Your Ideal Space: Let Us Navigate <br /> the Real Estate
                  Landscape for You
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[#808080] font-normal text-base">
                  Unlock the Door to Your Property <br /> Goals with SAK Real
                  Estate
                </p>
              </div>
            </div>
