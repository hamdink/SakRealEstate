...
const HeadingPage = ({
  ...
  <section className="min-h-screen bg-[url('/assets/background/heading-bg.png')] bg-top bg-cover bg-no-repeat lg:mb-24 md:mb-6 mb-48">
    <div className="w-full flex flex-col items-center justify-center mt-14">
      ...
      <div className="flex flex-col lg:flex-row gap-2 sm:gap-3 items-center lg:px-0 px-4 mt-4">
