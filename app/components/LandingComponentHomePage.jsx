...
const LandingComponentHomePage = () => {
  return (
    <div
      className="min-h-screen w-full flex flex-col justify-start items-center bg-[url('/assets/background/heading-bg.png')] bg-center bg-contain bg-no-repeat  mt-10
     lg:mt-20 "
    >
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          ...
          <div className=" bg-transparent flex justify-center items-center xs:w-[320px] sm:w-[583px] ">
            ...
            >
              <SwiperSlide>
                <img
                  src="/assets/houses/swiper1.png"
                  alt=""
                  className="w-[333px] sm:w-auto"
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
      ...
      <div className="w-full lg:w-[80%] flex flex-col md:flex-row justify-center gap-5 items-center p-4 lg:mt-20">
        <div
          ...
          className="bg-white flex justify-center items-center gap-2 p-4 rounded-[50px] "
        >
